...
class RolloutBuffer():
    ...
    def add_step_to_buffer(self, reward: torch.Tensor, value: torch.Tensor, log_prob: torch.Tensor, action: torch.Tensor, done: torch.Tensor, state: list[torch.Tensor], mask: torch.Tensor,
                           mask_env ) -> None:
    ...
    def get_minibatch(self, batch_indices):
        ...
        mask_env = [self.mask_env[i] for i in batch_indices]

        # Compute discounted rewards

        return states, actions, log_probs, advantages, returns, mask_env
